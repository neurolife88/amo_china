    ...
    >
      <defs>
        <linearGradient
          ...
          x2="91.6858"
          y2="107.4672"
          gradientTransform="matrix(1 0 0 -1 0 145.11)"
        >
        ...
        <linearGradient
          ...
          gradientTransform="matrix(1 0 0 -1 0 145.11)"
        >
          <stop offset="0" style={{ stopColor: "#FA3E5C" }} />
          <stop offset="1" style={{ stopColor: "#FF6958" }} />
        </linearGradient>
      </defs>
      <path
        fill="url(#neuro_grad1)"
        d="M141.6,35.5c-3.9-3.1-7.7-2.6-12.7-2.6c-2.4,0-6,0.4-8.1-0.8c-1.6-1-2.4-2.8-2.4-3.9c0,0,0-0.1,0-0.1
      ...
      <path fill="#FC4263" d="M67.4,36.4c-0.1,0.9,0.3,1.9,0.6,2.8c1.3,4.5,3.3,8.8,5.7,12.9c0.3,0.5,0.6,1.2,1,1.6c0.6,1,1.4,2.1,2.3,3.3
      ...
      <path fill="#FF7B8C" d="M91.2,66.7c0,0.8,0,1.6,0,2.4c6.6,3.4,13.6,5.4,21.4,5.8c1.9,0.1,4,0.2,5.9,0c0,4-1.1,7.1-4.6,10.1
        c-2.3,1.9-5.6,3.3-9,3.3c-3.3,0-6.5-1.2-8.9-3C93.4,83,91.6,80,91.3,77c-0.2-1.4-0.1-2.8-0.1-4.2L91.2,66.7z"/>
      <path fill="#FEA84C" d="M129,32.9c5,0,8.8-0.5,12.7,2.6c3.4,2.7,4.9,6.4,4.9,10.2c0,3.2-0.4,7.3-3.3,9.7c-0.4,0.3-0.9,0.6-1.4,0.9
